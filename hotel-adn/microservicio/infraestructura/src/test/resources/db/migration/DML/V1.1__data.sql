...
insert into usuario(id,nombre,clave,fecha_creacion) values(109,'Sophia','1234',now());
...
insert into tipoparqueadero (id, nombre,descripcion,precio) values (1,'carro','carro',3000);
insert into habitacion (id,tipo,disponible) values (1,1,1);
insert into habitacion (id,tipo,disponible) values (2,1,1);
insert into habitacion (id,tipo,disponible) values (3,1,1);
insert into parqueadero(id,idTipoParqueadero, disponible) values (1,1,1);
insert into parqueadero(id,idTipoParqueadero, disponible) values (2,1,1);
insert into parqueadero(id,idTipoParqueadero, disponible) values (3,1,1);
